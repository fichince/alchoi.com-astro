...
import chinatown from '../../../public/images/blog/interior-chinatown.jpeg';
import dreamhouse from '../../../public/images/blog/in-the-dream-house.jpeg';
import indians from '../../../public/images/blog/the-only-good-indians.jpeg';
...
<Picture 
  src={chinatown} alt="Interior Chinatown"
  widths={[140, 280]}
...
<Picture 
  src={dreamhouse} alt="In the Dream House"
  widths={[140, 280]}
  sizes="(min-width: 480px) 280px, 140px"
/>
...
<Picture 
  src={indians} alt="The Only Good Indians"
  widths={[140, 280]}
  sizes="(min-width: 480px) 280px, 140px"
/>
